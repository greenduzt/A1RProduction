...
{
    public class PrintMachinePartPDF
    {
        Document document;
        ...
        private Int32 machineWorkOrderId;
        private DateTime currentDate;

        public PrintMachinePartPDF(Machines v, Int32 id, ObservableCollection<MachinePartDescription> vpd)
        {
            currentDate = DateTime.Now;
            machine = v;
            machineWorkOrderId = id;
            machinePartDescription = vpd;
        }
        ...
        public Exception createWorkOrderPDF()
        {
            ...
            string filename = "MP" + machineWorkOrderId + "_" + currentDate.ToString("_ddMMyyyy_HHmmss") + ".pdf";
            try
            {
        ...
        public Document CreateDocument()
        {
            ...
            this.document.Info.Title = "Machine Parts";
            this.document.Info.Subject = "Machine Parts";
        ...
        void CreatePage()
        {
            ...
            paragraph = this.addressFrame.AddParagraph("Machine Parts");
            ...
            paragraph = this.addressFrame.AddParagraph("Work Order No - " + machineWorkOrderId);
            paragraph.Format.Font.Name = "Calibri";
            ...
            column2 = this.table.AddColumn("15.19cm");
            column2.Format.Alignment = ParagraphAlignment.Center;
            ...
            row4.Cells[0].AddParagraph(machine.MachineID.ToString());
            ...
            row4.Cells[1].AddParagraph(machine.MachineName);
            ...
            foreach (var item in machinePartDescription)
            {
                ...
                row2.Cells[0].AddParagraph(item.MachinePart.PartCode);
