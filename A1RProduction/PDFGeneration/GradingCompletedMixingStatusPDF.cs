...
{
    public class GradingCompletedMixingStatusPDF
    {
        private DateTime currentDate;
        Document document;
        TextFrame addressFrame;
        MigraDoc.DocumentObjectModel.Tables.Table table;
        private List<MixingOrder> mo;

        public GradingCompletedMixingStatusPDF(List<MixingOrder> m)
        {
            currentDate = DateTime.Now;
            mo = new List<MixingOrder>();
            mo = m;
        }
        ...
        public Exception CreatePDF()
        {
            ...
            string filename = "GCMS" + currentDate.ToString("_ddMMyyyy_HHmmss") + ".pdf";
            try
            {
                pdfRenderer.PdfDocument.Save("I:/PRODUCTION/DONOTDELETE/GradingCompletedMixingStatus/" + filename);

                ProcessStartInfo info = new ProcessStartInfo("I:/PRODUCTION/DONOTDELETE/GradingCompletedMixingStatus/" + filename);
                info.Verb = "Print";
        ...
        public Document CreateDocument()
        {
            ...
            this.document.Info.Title = "Mixing Pending Remport";
            this.document.Info.Subject = "Mixing Pending Report";
        ...
        void CreatePage()
        {
            ...
            paragraph = this.addressFrame.AddParagraph("Mixing Pending Report");
            ...
            Column itemsCol = this.table.AddColumn("6cm");
            ...
            itemRow.Cells[2].AddParagraph("Mixing Pending");
            ...
            foreach (var item in mo)
            {
                ...
                row2.Cells[0].AddParagraph(item.Product.RawProduct.RawProductCode);
                ...
                row2.Cells[1].AddParagraph(item.Product.RawProduct.Description);
                ...
                row2.Cells[2].AddParagraph(item.BlocksLogs.ToString("G23"));
                ...
                row2.Cells[3].AddParagraph(item.Order.IsRequiredDateSelected == true ? item.Order.MixingDate.ToString("dd/MM/yyyy") : "");
                ...
                row2.Cells[4].AddParagraph(item.Order.IsRequiredDateSelected == true ? item.Order.MixingShift : "");
