...
{
    public class SlittingProductionNotifier : IDisposable
    {
        ...
        public SlittingProductionNotifier()
        {
       ...
       public ObservableCollection<SlittingOrder> RegisterDependency()
        {
            ...
            this.CurrentCommand = new SqlCommand("SELECT Orders.order_id,Orders.sales_no,Orders.customer_id,Orders.required_date,Orders.slitting_comments, " +
                                                 ...
                                                 "WHERE SlittingOrders.blocks > 0 ", this.CurrentConnection);
